...
class RulerFragment : Fragment() {
    var types = arrayOf("simple User", "Admin")
    var index:Int=0
...
//    private val adapter = ExampleAdapter(exampleList)
    override fun onCreateView(
        ...
        val  recyclerView:RecyclerView=myView.findViewById(R.id.reyeclerRuler)
          spinKit=myView.findViewById(R.id.spin_kit)
        val arr = Array(9) { arrayOf("") }



        arr[0] =arrayOf("7.5", "11", "15", "18.5", "22","30","37","45","55","75","90","110","132","160","200")
        arr[1] =arrayOf("10", "15", "20", "25", "30","40","50","60","75","100","125","150","180","220","270")

        arr[2] =arrayOf("16", "22", "30", "37", "43","57","72","86","105","140","168","205","245","290","360")

        arr[3] =arrayOf("40", "40", "63", "80", "80","100","160","160","200","250","315","400","500","500","600 oder 800")

        arr[4] =arrayOf("25", "25", "40", "40", "63","63","100","100","160","160 oder 250","250","250","400","400","630")

        arr[5] =arrayOf("11 - 16", "16 - 26", "20 - 32", "30 - 45", "30 - 45","40 - 63","60 - 90","60 - 90","80 - 130","100 - 160","130 - 210","160 - 210","160 - 250","200 - 400","200 - 400")
        arr[6] =arrayOf("4", "6", "6", "10", "10","16","25","25","35","50","70","95","120","185","240")
        arr[7] =arrayOf("100", "110", "80", "105", "90","100","140","110","120","130","150","175","200","225","250")

        (0..7).forEach { i -> println(arr[i][index])
        }
    ...
    private fun  setSpinner( myView:View,arr: Array<Array<String>>,recycler_view:RecyclerView){
        spinner.adapter = ArrayAdapter(myView.context, R.layout.spinner_item, types) as SpinnerAdapter
...
return list
    ...
    private fun setRecyclerView(arr: Array<Array<String>>,recycler_view:RecyclerView,view:View){
